...
export default function AdminPromoCodesPage() {
    ...
    const checkStripeStatus = async () => {
        try {
            // Use the same API route as the settings page — it runs server-side
            // with the admin client and correctly resolves the tenant via tenant_members
    ...
    const getDiscountDisplay = (coupon: Coupon) => {
        ...
        if (coupon.amount_off) return `£${coupon.amount_off} off`;
        return 'Unknown';
    };
