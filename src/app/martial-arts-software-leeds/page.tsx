...
export const metadata = {
    title: 'Martial Arts Club Management Software Leeds | #1 for BJJ & MMA | ClubForge',
    description: 'ClubForge is the leading martial arts club management software for Leeds academies. Purpose-built for BJJ, MMA, Karate & Judo clubs across West Yorkshire. Manage memberships, Stripe payments, attendance & belt progression. Free 14-day trial.',
    ...
    openGraph: {
        ...
        description: 'The all-in-one management platform for martial arts academies across Leeds and West Yorkshire. Memberships, payments, attendance, belt progression — one system.',
    ...
    keywords: [
        ...
        'martial arts academy software Leeds',
        'gym management software Leeds',
        'MMA gym software Leeds',
        'karate dojo management Leeds',
        'martial arts membership software Leeds',
        'belt progression tracking Leeds',
        'West Yorkshire martial arts software',
...
const faqs = [
    {
        question: 'What is the best martial arts management software in Leeds?',
        answer: 'ClubForge is purpose-built for martial arts academies in Leeds, offering belt progression tracking, automated Stripe payments, attendance monitoring, class scheduling, and family accounts — all in one platform. Unlike generic gym software like Mindbody or Glofox, ClubForge includes martial arts–specific features out of the box.',
    },
    {
        question: 'Can I use ClubForge for a BJJ academy in Leeds?',
        answer: 'Absolutely. ClubForge is designed specifically for BJJ academies, with built-in belt and stripe tracking across all IBJJF ranks, attendance monitoring per class type, and automated Stripe billing. BJJ clubs across Leeds and West Yorkshire use ClubForge to manage their operations.',
    },
    {
        question: 'How much does martial arts club software cost in Leeds?',
        answer: 'ClubForge offers a free tier for new clubs, with paid plans from £39/month for up to 150 members. The Pro plan at £129/month supports up to 750 members and 3 locations. No setup fees, no contracts, and a 14-day free trial on all plans.',
    },
    {
        question: 'Does ClubForge support multi-location clubs across West Yorkshire?',
        answer: 'Yes. ClubForge\'s multi-location support lets you manage members, classes, schedules, and payments across all your venues from one dashboard. Whether you have sites in Leeds city centre, Bradford, Wakefield, or Huddersfield, everything stays connected.',
    },
    {
        question: 'How does ClubForge compare to Kicksite or Zen Planner?',
        answer: 'Kicksite is designed for American-style martial arts schools and Zen Planner for general fitness. ClubForge is purpose-built for UK martial arts clubs, with native GBP pricing, Stripe integration, and belt progression systems designed for BJJ, Karate, Judo, and more.',
    },
    {
        question: 'Can ClubForge handle kids martial arts classes in Leeds?',
        answer: 'Yes. ClubForge includes family accounts that let parents manage multiple children from a single login. Each child gets their own attendance record, belt progression, and class enrolments — perfect for Leeds clubs running children\'s programmes.',
    },
    {
        question: 'Does ClubForge offer attendance tracking for Leeds clubs?',
        answer: 'ClubForge provides one-click mobile check-ins for every class. Coaches can see real-time attendance, track member consistency, and use attendance data to inform grading decisions. Full reporting dashboards show retention trends across your Leeds academy.',
    },
    {
        question: 'Is ClubForge suitable for small martial arts clubs in Leeds?',
        answer: 'ClubForge scales with your club. The free tier is perfect for brand-new clubs, and the Starter plan at £39/month supports up to 150 members. No long-term contracts — upgrade or downgrade anytime.',
    },
];
...
export default async function LeedsPage() {
    ...
    const localBusinessSchema = {
        ...
        name: 'ClubForge — Martial Arts Software Leeds',
        description: 'Club management software for martial arts academies in Leeds. Manage memberships, payments, attendance, belt progression, and class scheduling.',
        url: 'https://clubforgehq.com/martial-arts-software-leeds',
        applicationCategory: 'BusinessApplication',
        applicationSubCategory: 'Gym Management Software',
        operatingSystem: 'Web',
        areaServed: { '@type': 'City', name: 'Leeds', containedInPlace: { '@type': 'Country', name: 'United Kingdom' } },
    ...
    return (
        <>
            ...
            <BreadcrumbSchema items={[{ name: 'Home', url: 'https://clubforgehq.com' }, { name: 'Martial Arts Software Leeds', url: 'https://clubforgehq.com/martial-arts-software-leeds' }]} />
            ...
            <main>
                ...
                <section style={{ background: 'linear-gradient(180deg, #0F172A 0%, #1E293B 100%)', padding: '140px 24px 80px', color: '#FFFFFF', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '24px', background: 'rgba(197,164,86,0.12)', padding: '8px 16px', borderRadius: '100px', border: '1px solid rgba(197,164,86,0.2)' }}>
                            ...
                            <span style={{ fontSize: '13px', fontWeight: '600', color: '#C5A456', letterSpacing: '0.03em' }}>Serving clubs across Leeds &amp; West Yorkshire</span>
                        </div>
                        ...
                        <h1 style={{ fontSize: 'clamp(2rem, 4.5vw, 3.5rem)', fontWeight: '800', lineHeight: '1.1', marginBottom: '20px', color: '#FFFFFF' }}>
                            ...
                            <span style={{ background: 'linear-gradient(135deg, #D4B86A, #A88B3D)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Leeds</span>
                        </h1>

                        <p style={{ fontSize: '1.15rem', color: '#94A3B8', lineHeight: '1.7', marginBottom: '16px', maxWidth: '650px' }}>
                            Leeds is one of Northern England&apos;s martial arts hotspots, with over 80 clubs across the city and wider West Yorkshire region. ClubForge is the management platform built specifically for them.
                        </p>
                        <p style={{ fontSize: '1rem', color: '#64748B', marginBottom: '16px', maxWidth: '650px', lineHeight: '1.7' }}>
                            Manage memberships, automate Stripe payments, track attendance, and handle belt progression — all from one system designed for BJJ, MMA, Karate, and martial arts academies.
                        </p>
                ...
                <section style={{ background: '#FFFFFF', padding: '60px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
                        <div className="cf-city-stats-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px' }}>
                            {[
                                { value: '812K+', label: 'Leeds population', icon: Users },
                                { value: '80+', label: 'Martial arts clubs', icon: Swords },
                                { value: '2.3M', label: 'West Yorkshire metro', icon: Building2 },
                ...
                <section style={{ background: '#FAFBFC', padding: '80px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <p style={{ fontSize: '14px', fontWeight: '600', color: '#C5A456', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '16px', textAlign: 'center' }}>The Leeds Martial Arts Scene</p>
                        <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '800', color: '#0F172A', textAlign: 'center', marginBottom: '24px', lineHeight: '1.2' }}>
                            Why Leeds martial arts clubs need specialist software
                        </h2>
                        <div style={{ color: '#475569', lineHeight: '1.8', fontSize: '1rem' }}>
                            <p style={{ marginBottom: '16px' }}>
                                Leeds is one of the largest cities in the UK, with a population exceeding 812,000 and a wider West Yorkshire metropolitan area of 2.3 million people. The city has developed a vibrant martial arts community, with over 80 clubs teaching everything from Brazilian Jiu-Jitsu and MMA to traditional Karate, Judo, Taekwondo, and Muay Thai.
                            </p>
                            <p style={{ marginBottom: '16px' }}>
                                The city&apos;s martial arts scene benefits from a strong university presence — with the University of Leeds and Leeds Beckett University bringing a steady stream of students interested in combat sports. This creates a unique dynamic where clubs serve both long-term community members and transient student populations, making flexible membership management essential.
                            </p>
                            <p style={{ marginBottom: '16px' }}>
                                Leeds&apos; position at the heart of West Yorkshire also means many clubs draw members from across the region — Bradford, Wakefield, Huddersfield, and Halifax. For clubs operating across multiple locations or serving a wide catchment area, having a centralised management system is critical to maintaining consistent operations and member experience.
                            </p>
                            <p style={{ marginBottom: '0' }}>
                                ClubForge was designed for exactly these challenges. Purpose-built for martial arts — not retrofitted from generic fitness software — it handles <Link href="/features/payments-billing" style={{ color: '#C5A456', textDecoration: 'none', fontWeight: '600' }}>automated payments</Link>, <Link href="/features/attendance-tracking" style={{ color: '#C5A456', textDecoration: 'none', fontWeight: '600' }}>attendance tracking</Link>, <Link href="/features/belt-progression" style={{ color: '#C5A456', textDecoration: 'none', fontWeight: '600' }}>belt progression</Link>, and <Link href="/features/class-scheduling" style={{ color: '#C5A456', textDecoration: 'none', fontWeight: '600' }}>class scheduling</Link> in one integrated platform.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section style={{ background: '#FFFFFF', padding: '80px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '900px', margin: '0 auto' }}>
                        ...
                        <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '800', color: '#0F172A', textAlign: 'center', marginBottom: '48px', lineHeight: '1.2' }}>
                            Everything Leeds martial arts clubs need
                        </h2>
                ...
                <section style={{ background: '#FAFBFC', padding: '80px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <p style={{ fontSize: '14px', fontWeight: '600', color: '#C5A456', textTransform: 'uppercase', letterSpacing: '1.5px', marginBottom: '16px', textAlign: 'center' }}>Why Leeds Clubs Choose ClubForge</p>
                        <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '800', color: '#0F172A', textAlign: 'center', marginBottom: '24px', lineHeight: '1.2' }}>
                            Built for West Yorkshire&apos;s martial arts community
                        </h2>
                        <div className="cf-city-local-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px', marginTop: '32px' }}>
                            {[
                                { icon: Building2, title: 'West Yorkshire Coverage', desc: 'Clubs across Leeds, Bradford, Wakefield, and Huddersfield can manage all locations from one dashboard with multi-location support.' },
                                { icon: Users, title: 'Student & Community Mix', desc: 'Leeds\' university population means flexible memberships are essential. ClubForge handles monthly, termly, and annual plans effortlessly.' },
                                { icon: Clock, title: 'Save Hours Every Week', desc: 'Automate payments, attendance logging, and member communications. Focus on coaching, not spreadsheets.' },
                                { icon: Star, title: 'Affordable for Every Club', desc: 'Start free, scale as you grow. From £0/month for new clubs to £349/month for large multi-location academies. No contracts.' },
                            ].map((item) => (
                ...
                <section style={{ background: 'linear-gradient(180deg, #0F172A 0%, #1A2332 100%)', padding: '80px 24px', position: 'relative', overflow: 'hidden' }}>
                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
                        ...
                        <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '800', color: '#FFFFFF', textAlign: 'center', marginBottom: '16px', lineHeight: '1.2' }}>Why not Kicksite, Zen Planner, or TeamUp?</h2>
                        <p style={{ fontSize: '1rem', color: '#94A3B8', textAlign: 'center', marginBottom: '48px', maxWidth: '650px', margin: '0 auto 48px', lineHeight: '1.7' }}>
                            Generic gym platforms lack the belt tracking, grading management, and martial arts–specific workflows that Leeds clubs need.
                        </p>
                        <div className="cf-city-why-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
                            {[
                                ...
                                { icon: Shield, title: 'UK pricing in GBP', desc: 'No USD conversion surprises. UK-based support and features for the UK market.' },
                            ].map((item) => (
                ...
                <section style={{ background: '#FFFFFF', padding: '80px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        <h2 style={{ fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: '800', color: '#0F172A', textAlign: 'center', marginBottom: '24px', lineHeight: '1.2' }}>Software for every martial art in Leeds</h2>
                ...
                <section style={{ background: '#FAFBFC', padding: '80px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                        ...
                        <h2 style={{ fontSize: 'clamp(1.3rem, 3vw, 1.8rem)', fontWeight: '800', color: '#0F172A', textAlign: 'center', marginBottom: '36px', lineHeight: '1.2' }}>Common questions from Leeds martial arts clubs</h2>
                ...
                <section style={{ background: 'linear-gradient(135deg, #D4B86A 0%, #C5A456 40%, #A88B3D 100%)', padding: '80px 24px', textAlign: 'center' }}>
                    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
                        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '20px', background: 'rgba(15,23,42,0.1)', padding: '8px 16px', borderRadius: '100px' }}><MapPin size={14} color="#0F172A" /><span style={{ fontSize: '13px', fontWeight: '600', color: '#0F172A' }}>Leeds</span></div>
                        <h2 style={{ color: '#0F172A', fontSize: 'clamp(1.6rem, 3vw, 2.2rem)', fontWeight: '800', marginBottom: '16px', lineHeight: '1.2' }}>Ready to professionalise your Leeds martial arts club?</h2>
                        <p style={{ color: 'rgba(15,23,42,0.6)', fontSize: '1rem', marginBottom: '32px', lineHeight: '1.7' }}>Join clubs across West Yorkshire using ClubForge. 14-day free trial — no card required.</p>
                ...
                <section style={{ background: '#FAFBFC', padding: '48px 24px', borderTop: '1px solid #F1F5F9' }}>
                    <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center', display: 'flex', flexDirection: 'column', gap: '12px', alignItems: 'center' }}>
                        ...
                        <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
                            {[
                                { href: '/martial-arts-software-london', label: 'London' }, { href: '/bjj-gym-software-manchester', label: 'Manchester' }, { href: '/gym-management-birmingham', label: 'Birmingham' },
                                { href: '/bjj-gym-software-liverpool', label: 'Liverpool' }, { href: '/martial-arts-software-glasgow', label: 'Glasgow' }, { href: '/gym-management-edinburgh', label: 'Edinburgh' },
                                { href: '/martial-arts-software-bristol', label: 'Bristol' }, { href: '/bjj-gym-software-sheffield', label: 'Sheffield' }, { href: '/martial-arts-software-nottingham', label: 'Nottingham' },
                                { href: '/gym-management-leicester', label: 'Leicester' }, { href: '/martial-arts-software-newcastle', label: 'Newcastle' },
                            ].map((city, i) => (<span key={city.href}>{i > 0 && <span style={{ color: '#E2E8F0', marginRight: '16px' }}>·</span>}<Link href={city.href} style={{ fontSize: '14px', color: '#C5A456', fontWeight: '600', textDecoration: 'none' }}>{city.label}</Link></span>))}
                        </div>
