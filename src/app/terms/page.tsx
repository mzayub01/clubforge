...
export const metadata = {
    ...
    description: 'Terms of Service for ClubForge - The terms and conditions governing your use of our services.',
};
                    ...
                    <div className="container container-md">
                        <div className="glass-card" style={{ padding: 'var(--space-8)' }}>
                            ...
                            <div style={{ lineHeight: '1.8', color: 'var(--text-secondary)' }}>
                                ...
                                <p>
                                    These Terms of Service (&quot;Terms&quot;) govern your use of the ClubForge website, services, and membership. ClubForge operates under the registered charity ClubForge in England and Wales.
                                </p>
                                <p>
                                ...
                                <p>
                                    ClubForge may take photographs or videos during classes and events for promotional purposes. By participating, you consent to the use of such media unless you notify us in writing otherwise.
                                </p>
                                <p>
                                ...
                                <p>
                                    All content on the ClubForge website, including text, graphics, logos, and training materials, is the property of ClubForge or its licensors and is protected by copyright laws.
                                </p>
                                ...
                                <ul style={{ paddingLeft: 'var(--space-6)' }}>
                                    <li>ClubForge is not liable for any injuries sustained during training where reasonable safety measures were in place</li>
                                ...
                                <p>
                                    ClubForge is committed to safeguarding children and vulnerable adults. We have comprehensive safeguarding policies in place, and all instructors are DBS-checked. Any concerns should be reported immediately to our safeguarding lead.
                                </p>
