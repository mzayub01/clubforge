                ...
                <div style={{
                    ...
                    <div className="animate-scale-in" style={{
                        ...
                        <div style={{
                            ...
                            <p style={{ marginBottom: 'var(--space-4)' }}>
                                <strong>For existing members:</strong> Your payments should already be set up. If they have not, please email <a href="mailto:support@clubforge.com" style={{ color: 'var(--color-gold)' }}>support@clubforge.com</a> stating your payments have not yet been set up.
                            </p>
